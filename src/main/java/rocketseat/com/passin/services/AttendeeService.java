...
import rocketseat.com.passin.domain.attendee.exceptions.AttendeeNotFundException;
...
public class AttendeeService {
    ...
    private Attendee getAttendee(String attendeeId){
       return this.attendeeRepository.findById(attendeeId).orElseThrow(() -> new AttendeeNotFundException("Attendee not found with ID: " + attendeeId));
    }
